...
In the event on-premise services are chosen, please inform the responsible IT department as soon as possible. Provide them with the appropriate implementation guides for `smartSuggest <module-smartsuggest.html>`_ and `smartQuery <module-smartquery.html>`_.
